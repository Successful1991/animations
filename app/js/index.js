...
function VideoPlayer() {
  ...
  videoElem.setAttribute('src', './app/img/Ecomm-fashion_FP2.mp4');
...
VideoPlayer.prototype.init = function() {
  ...
  this.fetchData('data.json', function callback() {
    ...
    $('.animate4__block1-text2__discount').text (
      self.data.amount11
    );
    $('.animate4__block1-text2__regular').append(
      self.data.amount1regular
    );
    $('.animate4__block2-text1').text (
      self.data.amount2
    );
    $('.animate4__block2-text2__discount').text (
      self.data.amount21
    );
    $('.animate4__block2-text2__regular').append (
      self.data.amount2regular
    );
    $('.animate4__block3-text1').text (
      self.data.amount3
    );
    $('.animate4__block3-text2__discount').text (
      self.data.amount31
    );
