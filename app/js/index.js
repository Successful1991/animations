...
function VideoPlayer() {
  ...
  videoElem.setAttribute('src', './app/img/RestaurantNoText.mp4');
...
VideoPlayer.prototype.init = function() {
  ...
  this.fetchData('data.json', function callback() {
    ...
    $('.animate4__text1').text(self.data.text41);
    $('.animate4__text2').text(self.data.text42);
    //$('#animate21').text(self.data.text21);

    self.divideWordIntoLettersMs(self.data.text21,"#animate21",19.5,"animateLetter");
    self.divideWordIntoLettersMs(self.data.text22,"#animate22",20.1,"animateLetter");
    self.divideWordIntoLettersMs(self.data.text23,"#animate23",20.5,"animateLetter");
    self.divideWordIntoLetters2(self.data.text3,"#animate3",24.1,"animateLetter2");
    self.divideWordIntoLettersMs(self.data.text4,"#animate4",37.4,"animateLetter2");
