...
function VideoPlayer() {
  ...
  videoElem.setAttribute('src', './app/img/personalized2.mp4');
...
VideoPlayer.prototype.init = function() {
  ...
  this.fetchData('data.json', function callback() {
     ...
     $('#animate1-text3').text(self.data.text13);
     $('#animate1-img1').css({"background": "url("+ self.data.img1 +") center no-repeat","background-size": "contain"});

    $('#animate2-text').text(self.data.text21);

    $('#animate2-line1-text1').text(self.data.text211);
    $('#animate2-line1-amount1').text(self.data.amount211);
    $('#animate2-line1-amount2').text(self.data.amount212);

    $('#animate2-line2-text1').text(self.data.text221);
    $('#animate2-line2-amount1').text(self.data.amount221);
    $('#animate2-line2-amount2').text(self.data.amount222);

    $('#animate2-line3-text1').text(self.data.text231);
    $('#animate2-line3-amount1').text(self.data.amount231);
    $('#animate2-line3-amount2').text(self.data.amount232);

    $('#animate3-text').text(self.data.text3);

    $('#animate4-text1').text(self.data.text41);
    //$('#animate4-amount1').text(self.data.amount41);
    $('#animate4-amount2').append(self.data.amount41);


    $('#animate5').text(self.data.text5);
    // self.divideWordIntoLetters (self.data.text1,"#textAnimate1",4.1);
    // self.divideWordIntoLetters (self.data.text2,"#textAnimate2",4.3);
    ...
    $ ('.charlie').on (self.animationStart, function (el) {
      if (this.id === 'animate4-amount1') {
        self.numberAnimation (self.data.amount41, 0, 50, this);
      }else(console.log("не сработало"))
    });
