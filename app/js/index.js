...
VideoPlayer.prototype.init = function() {
  ...
  this.fetchData('data.json', function callback() {
    ...
    $('#animate1-amount2').text(self.data.amount2);
    $('#animate1-account3').text(self.data.account3);
    $('#animate1-amount3').text(self.data.amount3);
    $('#animate1-account4').text(self.data.account4);
